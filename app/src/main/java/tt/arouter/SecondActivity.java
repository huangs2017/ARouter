...
public class SecondActivity extends Activity {
    ...
    @Extra TestParcelable j;
    @Extra TestParcelable[] jj;
    ...
    @Extra(name = "/main/service1")     IService testService1;
    @Extra(name = "/main/service2")     IService testService2;
    @Extra(name = "/module1/service")   IService testService3;
    @Extra(name = "/module2/service")   IService testService4;
